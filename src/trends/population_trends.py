...
def add_gdp_cagr_feature(year_list, api_key):
    """
    ...
    criteria = f"&Year={year_list[1]},{year_list[0]}&GeoFips=MSA&ResultFormat=json"
...
def add_wage_cagr_feature(year_list, api_key):
    """
...
def add_industry_delta_and_cagr_features(data, industry_dict, year_list):
    """
    ...
    for item in add_items:
        data[item + "_delta"] = (
            data[item + "_" + str(year_list[0])] - data[item + "_" + str(year_list[1])]
        )
